...
class APIController extends Controller
{
    ...
    public function index()
    {
        if (isset($_GET['charname']) && $_GET['realmname']) {
            ...
            $url = @file_get_contents("https://eu.api.battle.net/wow/character/" . $_GET['realmname'] . "/" . $_GET['charname'] . "?fields=items&locale=en_GB&apikey=" . $key);
            if($url===FALSE){
                return $this->render('api/api.html.twig', [
                    'errormsg'=>'False character/realm-name'
                ]);
            }
            else {
                ...
                return $this->render('api/api.html.twig', [
                    ...
                    'profile_ilvl' => $json_a['items']['averageItemLevel'],
